...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>階段一 - 步驟四 : 確認故事的數位工具</a></h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>此步驟是說明數位敘事<span style="color: yellow;">〝呈現方式〞（animaker, powtoon, prezi, ppt等）</span>的地方.</p></div>
	</div>
...
<?php foreach ( $tools as $row ) : ?>
	  ...
	  <div class="w3-col w3-container w3-quarter"><a href="phase_1_1_step4_edit.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-edit' style='font-size:24px'></i></a><a href="phase_1_1_step4_delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Do you want to delete?');" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-trash-alt' style='font-size:24px'></i></a></div>
	</div>
